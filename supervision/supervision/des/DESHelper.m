...
+ (NSString *) encode:(NSString *)str key:(NSString *)key
{
    ...
    NSMutableString* str1 = [DESHelper urlEncode:str];
    NSMutableString* encode = [NSMutableString stringWithString:[DESHelper doCipher:str1 key:key context:kCCEncrypt]];
    [DESHelper formatSpecialCharacters:encode];
    return encode;
}
...
+ (NSString *) decode:(NSString *)str key:(NSString *)key
{
    ...
    [DESHelper reformatSpecialCharacters:str1];
    NSString *rt = [DESHelper doCipher:str1 key:key context:kCCDecrypt];
    return rt;
}

+ (NSMutableString *)urlEncode:(NSString*)str
{
    NSMutableString* encodeStr = [NSMutableString stringWithString:[str stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLHostAllowedCharacterSet]]];
...
+ (NSString *)encodeBase64WithString:(NSString *)strData {
    return [DESHelper encodeBase64WithData:[strData dataUsingEncoding:NSUTF8StringEncoding]];
 //   return strData;
}
...
+ (NSString *)doCipher:(NSString *)sTextIn key:(NSString *)sKey
    ...
    if (encryptOrDecrypt == kCCDecrypt) {
        dTextIn = [[DESHelper decodeBase64WithString:sTextIn] mutableCopy];
    }
    else{
    ...
    if (encryptOrDecrypt == kCCDecrypt){
        ...
        free(bufferPtr1);
        //sResult = [DESHelper encodeBase64WithData:dResult];
        //sResult = [DESHelper decodeBase64WithString:sResult];
        sResult = [DESHelper convertDataToHexStr:dResult].uppercaseString;
    }
    return sResult;
}
